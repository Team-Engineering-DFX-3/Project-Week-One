...
export default function UserProfileEdit() {
    ...
    const handleSubmit = async (e) => {
        ...
        e.preventDefault();
        try {
            const response = await axios.post('https://cors-anywhere.herokuapp.com/http://172.31.95.86:4000/editUser', userData);
    ...
    useEffect(() => {
        async function getDegrees() {
            let response = await axios.get('https://cors-anywhere.herokuapp.com/http://172.31.95.86:4000/editDegree');
    ...
    useEffect(() => {
        async function getWork() {
            let response = await axios.get('https://cors-anywhere.herokuapp.com/http://172.31.95.86:4000/editWork');
    ...
    useEffect(() => {
        async function getSchool() {
            let response = await axios.get('https://cors-anywhere.herokuapp.com/http://172.31.95.86:4000/editSchool');
    ...
    useEffect(() => {
        async function getPortfolio() {
            let response = await axios.get('https://cors-anywhere.herokuapp.com/http://172.31.95.86:4000/editPortfolio');
    ...
    useEffect(() => {
        async function getAward() {
            let response = await axios.get('https://cors-anywhere.herokuapp.com/http://172.31.95.86:4000/editAward');
