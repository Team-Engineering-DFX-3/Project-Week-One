...
export default function IndustryProfileEdit() {
    ...
    const getIndustry = async () => {
        try {
            const response = await axios.get('https://cors-anywhere.herokuapp.com/http://ec2-3-219-197-22.compute-1.amazonaws.com:4000/editindustry/' + `${id}`);
            return response;
        }
        catch (e) {
            return "failure";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios({
                method: 'put', url: `https://cors-anywhere.herokuapp.com/http://ec2-3-219-197-22.compute-1.amazonaws.com:4000/editIndustry/` + `${id}`,
                data: formData,
                headers: {
                        ...
                        <div className="row">
                            ...
                            <div className=' col-sm body-align-right' id='right'>
                                <ul className='list body-align-right' id='right' >
                                    <li><img src={state.image && `https://cors-anywhere.herokuapp.com/http://ec2-3-219-197-22.compute-1.amazonaws.com:4000` + `${state.image}`} alt="Industry Logo" className="img" /></li>
